...
function playerMetaTable:CheckGroup(groupName)
	return true
end

ULib = { ucl = {} }
ULib.ucl.query = function(ply, requiredPermission)
	return not (requiredPermission == "ulx slay")
end

concommand.Add("ulx", function(ply, cmd, args, argStr)
	print(argStr)
end)
--]]
