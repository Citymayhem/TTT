...
if SERVER then
   ...
   resource.AddFile("materials/VGUI/ttt/icon_cm_pump.vmt")
end
...
if CLIENT then
   ...
   SWEP.Slot = 2
   SWEP.Icon = "VGUI/ttt/icon_cm_pump"
end
...
SWEP.IronSightsPos = Vector(-7.55, -9.214, 2.66)
SWEP.IronSightsAng = Vector(-0.101, 0.2, -0.201)
